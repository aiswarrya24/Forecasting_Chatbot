...
###DOWNLOAD THE JSON FILE INOT YOUR MONOGO DB###

remove the triple quotes in the db.py file in the start and the end
...
Use the following command to start SalesBot:
